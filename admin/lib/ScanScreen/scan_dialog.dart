...
class _PushDialogState extends State<PushDialog> {
  ...
  final _url = 'http://158.247.215.83:5000/train'; //Push -> Training AI
  final _url2 =
      'http://158.247.215.83:5000/predict'; //Predict -> Current Positioning
  late Future<Response> postFuture;

  Map<String, dynamic> pushJson(String spot) {
    Map<String, dynamic> jsonData = {};
    List<Map<String, dynamic>> aplist = [];
    for (var wifi in ScanScreen.gcEdu) {
      aplist.add({
        "ssid": wifi.ssid,
        "bssid": wifi.bssid,
        "quality": wifi.level.abs(),
      });
    }
